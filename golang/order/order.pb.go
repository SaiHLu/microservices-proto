...
const file_order_order_proto_rawDesc = "" +
	...
	"orderItems2\x84\x01\n" +
	"\x05Order\x12A\n" +
	"\x06Create\x12\x19.order.CreateOrderRequest\x1a\x1a.order.CreateOrderResponse\"\x00\x128\n" +
	"\x03Get\x12\x16.order.GetOrderRequest\x1a\x17.order.GetOrderResponse\"\x00B'Z%github.com/SaiHLu/microservices/orderb\x06proto3"
