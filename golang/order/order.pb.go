...
const file_order_order_proto_rawDesc = "" +
	...
	"\border_id\x18\x01 \x01(\x03R\aorderId2J\n" +
	"\x05Order\x12A\n" +
	"\x06Create\x12\x19.order.CreateOrderRequest\x1a\x1a.order.CreateOrderResponse\"\x00B'Z%github.com/SaiHLu/microservices/orderb\x06proto3"
